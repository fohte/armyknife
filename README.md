...
| `--branch-config <key=value>` | Set `git config branch.<branch>.<key> <value>` on the created/checked-out branch (requires `--worktree`); repeatable. armyknife does not interpret `key`                                                                                                                                                                                                                                                            |
