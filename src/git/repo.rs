...
mod tests {
    ...
    #[rstest]
    #[case::no_remote_branches(vec![], "master")]
    #[case::only_origin_main(vec!["main"], "main")]
    #[case::only_origin_master(vec!["master"], "master")]
    #[case::both_prefers_main(vec!["main", "master"], "main")]
    fn test_get_main_branch_for_repo(#[case] remote_branches: Vec<&str>, #[case] expected: &str) {
